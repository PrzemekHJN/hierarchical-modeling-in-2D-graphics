...
//-------------------------- Create the world and implement the animation --------------
    ...
    private void scenedrawing(Graphics2D g2)
    {
        ...
        // right bot
        g2.translate(1.93, -1.98);
        g2.setColor( Color.gray );
        g2.rotate( Math.toRadians (frameNumber * 0.25 ));
        g2.scale( 0.0053, 0.0053 );
        g2.fill(polygon);
        g2.setColor(saveColor);
        g2.setTransform(saveTransform);

        g2.translate(-0.38, 0.02);
        g2.setColor( Color.gray );
        g2.rotate( Math.toRadians ( frameNumber * 0.45 ));
        g2.scale( 0.0053, 0.0053 );
        g2.fill(polygon);
        g2.setColor(saveColor);
        g2.setTransform(saveTransform);

        g2.translate(0.7,-2.25);
        ...
        // left top
        g2.translate(-4.4, 3.13);
        g2.setColor( Color.gray );
        g2.rotate( Math.toRadians ( frameNumber * 0.55 ));
        ...
        g2.translate(-1.4, 2.25);
        g2.setColor( Color.gray );
        g2.rotate( Math.toRadians ( frameNumber * 0.9 ));
        g2.scale( 0.005, 0.005 );
        g2.fill(polygon);
        g2.setColor(saveColor);
        g2.setTransform(saveTransform);
    ...
    { // width = 1, height = 1, center of base is at (0,0);
        Path2D path = new Path2D.Double();
        path.moveTo(-0.5,0);
        path.lineTo(0.5,0);
        path.lineTo(0,1);
